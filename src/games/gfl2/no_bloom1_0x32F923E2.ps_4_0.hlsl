#include "./common.hlsl"
// ---- Created with 3Dmigoto v1.3.2 on Sat Apr 12 13:44:34 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r1.x != 0) {
    r2.xyzw = t12.Sample(s1_s, r0.zw).xyzw;
    r0.zw = r2.xy + r0.zw;
  }
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t10.Sample(s6_s, r2.xy).xyzw;
    r1.z = r2.w * 2 + -1;
  ...
  if (r0.y != 0) {
    if (r1.y != 0) {
      ...
      if (r1.x != 0) {
        r8.xyzw = t12.Sample(s1_s, r4.xy).xyzw;
        r4.xy = r8.xy + r4.xy;
      }
      ...
      if (r1.x != 0) {
        r5.xyzw = t12.Sample(s1_s, r4.zw).xyzw;
        r4.zw = r5.xy + r4.zw;
      }
    }
  ...
  if (r0.x != 0) {
    ...
    if (r0.x != 0) {
      ...
      r4.xyzw = t9.Sample(s5_s, r0.xy).xyzw;
  ...
  if (r0.x != 0) {
    r2.xyzw = t7.Sample(s1_s, r0.zw).xyzw;
    r1.xyz = r2.xyz + r1.xyz;
  }
  ...
  r2.xyzw = t3.SampleLevel(s1_s, r1.xz, 0).xyzw;
  r4.x = cb0[1404].y;
  r4.y = 0;
  r1.xy = r4.xy + r1.xz;
  r1.xyzw = t3.SampleLevel(s1_s, r1.xy, 0).xyzw;
  ...
  if (r1.x != 0) {
    ...
    r4.xyzw = t4.SampleLevel(s1_s, r2.xz, 0).xyzw;
    r5.x = cb0[1405].y;
    r5.y = 0;
    r2.xy = r5.xy + r2.xz;
    r2.xyzw = t4.SampleLevel(s1_s, r2.xy, 0).xyzw;
  ...
  if (r1.x != 0) {
    ...
    r4.xyzw = t11.Sample(s1_s, v1.xy).xyzw;
    r4.y = cmp(0 < cb0[1463].w);
    if (r4.y != 0) {
      r2.zw = v1.yx;
      r5.xyzw = t11.Sample(s1_s, r2.xz).xyzw;
      r1.xw = v1.yx;
      r6.xyzw = t11.Sample(s1_s, r1.zx).xyzw;
      r7.xyzw = t11.Sample(s1_s, r1.wy).xyzw;
      r8.xyzw = t11.Sample(s1_s, r2.wy).xyzw;
      r2.z = r6.x + r5.x;
      r2.z = r2.z + r7.x;
      r2.z = r2.z + r8.x;
    } else {
    ...
    r1.xw = r2.xy;
    r5.xyzw = t11.Sample(s1_s, r1.xy).xyzw;
    r6.xyzw = t11.Sample(s1_s, r1.zy).xyzw;
    r7.xyzw = t11.Sample(s1_s, r2.xy).xyzw;
    r1.xyzw = t11.Sample(s1_s, r1.zw).xyzw;
    r1.y = r5.x + r2.z;
    r1.y = r1.y + r6.x;
    r1.y = r1.y + r7.x;
    r1.x = (r1.y + r1.x);
  ...
  if (r0.x != 0) {
    ...
    r1.z = r1.y * r0.z;
    r1.xyz = (r1.xyz);
    r2.xyzw = t6.Sample(s1_s, float2(0.5,0.5)).xyzw;
  ...
  if (r0.y != 0) {
    ...
    r0.xyzw = t8.Sample(s1_s, r0.xy).xyzw;
    r0.x = 1 + -r0.y;
